...
export const TimelineProgress = ({
    ...
    const handleMouseMove = (e: MouseEvent) => {
        if (progressContainerRef.current && timelineInfo.duration) {
            ...
            const time = (percentage * timelineInfo.duration) / 60;
    ...
    return (
        ...
        >
            ...
            >
                <div className={cn('h-1 w-1 rounded-full block absolute right-0 top-1/2 bottom-1/2 -translate-y-1/2 bg-gray-100 scale-[3] ', dotStyle)}
                    onMouseMove={handleClick}
                />
                {tooltip.visible && (<div className="bg-gray-100 rounded absolute top-[-2.5em] right-[-1.5em] px-2 py-1 text-black" aria-hidden="true"
                >
